...
import { ButtonText, FormControl, FormControlLabel, FormControlLabelText, Heading, Input, InputField, Textarea, TextareaInput, VStack, View, Button, ArrowRightIcon, ButtonIcon } from '@gluestack-ui/themed';
  ...
  return (
    <View style={styles.transfer}>
      ...
      <View style={{ rowGap: 18 }}>
          <FormControl size="sm" isDisabled={false} isInvalid={false} isReadOnly={false} isRequired={false} >
