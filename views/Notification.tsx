      ...
      >
        ...
        <View style={{}}>
          ...
          >
            ...
            >
              {item.amount == null ? "" : "+" + item.amount + " PLN"}
            </Text>
          </View>
          <Text style={{ color: "gray", fontSize: 14 }}>
  ...
  const transaction = [
    {
      ...
      transactionList: [
        {
          transactionType: "netflix",
          amount: null,
          description: "Trasakcja kartą płatniczą",
          timeNotification: "20 minut temu",
        },
        {
          transactionType: "spotify",
          amount: 30,
          description: "Trasakcja kartą płatniczą",
          timeNotification: "30 minut temu",
        },
      ],
    },
    {
      ...
      transactionList: [
        {
          transactionType: "youtube",
          amount: 120,
          description: "Trasakcja kartą płatniczą",
          timeNotification: "22 godziny temu",
        },
        {
          transactionType: "spotify",
          amount: 120,
          description: "Trasakcja kartą płatniczą",
          timeNotification: "1 dzień temu",
        },
        {
          transactionType: "spotify",
          amount: 120,
