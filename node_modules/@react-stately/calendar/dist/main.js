...
function $e49f7b861e5e8049$export$9a987164d97ecc90(props) {
    ...
    let min = (0, $hEzMm$react.useMemo)(()=>(0, $hEzMm$internationalizeddate.maxDate)(minValue, availableRange === null || availableRange === void 0 ? void 0 : availableRange.start), [
        minValue,
        availableRange
    ]);
    let max = (0, $hEzMm$react.useMemo)(()=>(0, $hEzMm$internationalizeddate.minDate)(maxValue, availableRange === null || availableRange === void 0 ? void 0 : availableRange.end), [
        maxValue,
        availableRange
    ]);
